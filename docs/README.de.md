...
Versionshinweise in [CHANGELOG.md](../CHANGELOG.md). **v1.0.3**: Leerlauf-Auto-Sperre für verschlüsselte Workspaces, optionale Neue-Notiz-Vorlagen, Korrekturen an Caret/Quellmodus/Versionsverlauf.
