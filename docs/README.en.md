...
**Docs:** [All languages](README.md) · [简体中文](README.zh-CN.md)

**Guide:** [Themes](guide/themes.md) · [Shortcuts & `/` commands](guide/shortcuts-and-menus.md) · [All guides](guide/README.md)
...
<p align="center">
  <a href="#preview">
    <img src="assets/demo/lunote-demo.gif" alt="Lunote — 10s demo: writing, wiki links, knowledge graph, and themes" width="720" />
  </a>
</p>
...
<p align="center">
  <img src="assets/screenshots/hero-preview.png" alt="Lunote main workspace" width="720" />
</p>

| Visual editor | Knowledge graph | Theme |
| :---: | :---: | :---: |
| <img src="assets/screenshots/editor-visual.png" alt="Visual editor" width="240" style="max-width: 100%; height: auto;" /> | <img src="assets/screenshots/knowledge-graph.png" alt="Knowledge graph" width="240" style="max-width: 100%; height: auto;" /> | <img src="assets/screenshots/theme-presets.png" alt="Export options" width="240" style="max-width: 100%; height: auto;" /> |
...
| **Address** | USDT · `{{SPONSOR_TRC20_ADDRESS}}` |
