...
Notes de version dans [CHANGELOG.md](../CHANGELOG.md). **v1.0.3** : verrouillage automatique après inactivité, modèles de nouvelle note optionnels, correctifs curseur / mode source / historique.
