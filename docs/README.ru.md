...
Заметки о релизах в [CHANGELOG.md](../CHANGELOG.md). **v1.0.4**: открытие рабочей области больше не зависает на экране загрузки; визуальный редактор остаётся на TipTap 3.23.1 (3.30/3.31 ломали правку).
