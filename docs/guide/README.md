# Lunote user guide (English)

Short, practical guides for the desktop app. For install, features, and downloads, see the [main README](../../README.md) or [docs index](../README.md).
...
| Area | Index |
|------|--------|
| Theme reference | [../theme/README.md](../theme/README.md) |
| Theme examples | [../theme-example/README.md](../theme-example/README.md) |
| Localized READMEs | [../README.md](../README.md#languages) |

**Also linked from:** every `docs/README.{locale}.md` file (paths resolve on GitHub as `docs/guide/…`).
