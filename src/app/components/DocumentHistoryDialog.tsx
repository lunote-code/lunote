...
import { buildDocumentHistoryDiffRows } from '../../documentHistory/historyDiff'
...
export function DocumentHistoryDialog({
  ...
  const diffRows = preview ? buildDocumentHistoryDiffRows(currentBody, preview.content).slice(0, DIFF_ROW_LIMIT) : []
  const diffHasChanges = preview ? currentBody !== preview.content : false
