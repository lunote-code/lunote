...
import { notifyContextWorkspaceChanged } from '../knowledgeSurfaceRuntime/contextWorkspaceRuntime'
import type { WorkspaceLayoutSnapshot } from '../knowledgeSurfaceRuntime/types'
