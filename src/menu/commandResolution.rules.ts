...
export const COMMAND_RESOLUTION_REGISTRY: Record<string, CommandResolver> = {
  ...
  'fmt-toc': resolveEditorCommand(
    'fmt-toc',
    { type: 'insertTocAtAppropriatePosition' },
    { kind: 'insert-toc-at-appropriate-position' },
  ),
  ...
  'para-drawing-canvas': resolveEditorCommand(
    'para-drawing-canvas',
    { type: 'drawingBlock' },
    { kind: 'insert-literal', text: '\n```drawing\n{"w":640,"h":360,"strokes":[]}\n```\n' },
  ),
  ...
  'daily-note-calendar-open': delegateApp('daily-note-calendar-open'),
  ...
  'view-knowledge-search': delegateApp('view-knowledge-search'),
  'view-quick-switcher': delegateApp('view-quick-switcher'),
  'view-tab-switcher': delegateApp('view-tab-switcher'),
  'view-ai-panel': delegateApp('view-ai-panel'),
  'view-ai-ask-selection': delegateApp('view-ai-ask-selection'),
  'view-ai-edit-selection': delegateApp('view-ai-edit-selection'),
  ...
  'help-reset-onboarding': delegateApp('help-reset-onboarding'),
